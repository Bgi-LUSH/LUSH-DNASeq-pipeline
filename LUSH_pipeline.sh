...
db_bqsr_mills=$db/hg19/Mills_and_1000G_gold_standard.indels.hg19.vcf
db_bqsr_1000g=$db/hg19/1000G_phase1.indels.hg19.vcf
db_bqsr_dbsnp=$db/hg19/dbsnp_151.hg19.vcf
